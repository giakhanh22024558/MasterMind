...
```bash
python ../../scripts/srs_md_to_docx.py SRS_Sample.md RoomBooking_SRS.docx
```
...
- [`content-format-separation`](../patterns/content-format-separation.md) — pure content in the `.md`, formatting applied by `srs_format.py`, the generator handles ID codes & figure numbers & numbering & cell merging.
