...
Architecture-specific edge label conventions. For cross-diagram-type principles (reference-ID + characterization format, prohibition format), see [`edge-labels-general`](../../../../../core/diagram/_shared/edge-labels-general/).
