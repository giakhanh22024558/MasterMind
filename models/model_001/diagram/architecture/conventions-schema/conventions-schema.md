...
For each item, the project should specify a value or explicitly accept the default from [`conventions-defaults.md`](../conventions-defaults/conventions-defaults.md).
...
If unspecified, [`conventions-defaults.md`](../conventions-defaults/conventions-defaults.md) palette applies.
