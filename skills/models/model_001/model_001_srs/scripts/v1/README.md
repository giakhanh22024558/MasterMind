...
Generator ghi file `.docx` — có thể là file sync-prone (OneDrive/Drive). Theo [`meta/atomic-edits-pattern/`](../../../../../../meta/atomic-edits-pattern/):
...
- Thay đổi phá vỡ tương thích → bump `scripts/v1` → `scripts/v2` theo [`meta/versioning-pattern/`](../../../../../../meta/versioning-pattern/)
