...
> Mọi content module của skill này được versioned ở leaf-folder (`v1/`, `v2/`…). Mặc định dùng `vN` cao nhất. Xem [`meta/versioning-pattern/`](../../../../meta/versioning-pattern/).
...
1. **Discover conventions** — tìm `<project-root>/model_001_srs-conventions.md` theo [`meta/conventions-as-data-pattern/`](../../../../meta/conventions-as-data-pattern/)
...
2. Nếu thay đổi phá vỡ tương thích → bump version module theo [`meta/versioning-pattern/`](../../../../meta/versioning-pattern/)
...
|---|---|
| [Uniform skill structure](../../../../meta/uniform-skill-structure/) | Skill theo layout Shape A bắt buộc |
| [Versioning pattern](../../../../meta/versioning-pattern/) | Mọi content module versioned ở leaf-folder |
| [Conventions as data](../../../../meta/conventions-as-data-pattern/) | Convention dự án ở `<project>/model_001_srs-conventions.md` |
| [Atomic edits](../../../../meta/atomic-edits-pattern/) | Generator ghi `.docx` (file sync-prone) — đọc 1 lần / ghi 1 lần, đóng Word trước khi chạy |
| [Defer-then-promote](../../../../meta/defer-then-promote-pattern/) | Khi giá trị Loại/Thuộc tính mới lặp lại nhiều lần → cân nhắc bổ sung vào Legend canonical |
