...
- Sync-prone files (cloud-synced .drawio, .docx, .xlsx) — use [atomic edits pattern](../../../_meta/atomic-edits-pattern/)
...
See [`../../../_meta/atomic-edits-pattern/`](../../../_meta/atomic-edits-pattern/) for the atomic-edit pattern when applicable.
