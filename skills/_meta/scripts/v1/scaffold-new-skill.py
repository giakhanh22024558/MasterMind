"""
Scaffold a new skill in `skills/` by copying the `_template/v1/` starter
...
WHAT IT DOES:
  1. Copies `skills/_template/v1/` to `skills/<new-skill-name>/`
...
def main():
    template_dir = SKILLS_ROOT / "_template" / "v1"
    ...
    print()
    print("Reference meta-patterns from `_meta/` for:")
    print("  - Versioning model: _meta/versioning-pattern/")
    print("  - Conventions as data: _meta/conventions-as-data-pattern/")
    print("  - Defer-then-promote: _meta/defer-then-promote-pattern/")
    print("  - Atomic edits: _meta/atomic-edits-pattern/")
