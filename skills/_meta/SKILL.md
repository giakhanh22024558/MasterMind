...
2. **Copy the template** (`skills/_template/v1/`) as starting skeleton
...
- If a pattern starts appearing in 3+ skills, **promote it to `_meta/`** (defer-then-promote applied to meta-patterns themselves)
