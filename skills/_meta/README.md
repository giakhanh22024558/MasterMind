...
| Scaffold a new skill from template | [`scripts/`](scripts/) + [`../_template/v1/`](../_template/v1/) |
...
`_meta/` itself follows the uniform skill structure — meta-patterns versioned at leaf-folder grain, just like any other skill.
