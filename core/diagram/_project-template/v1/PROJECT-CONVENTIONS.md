...
The project uses the 4-tier layout from [`_shared/folder-structure-general`](https://github.com/giakhanh22024558/MasterMind/blob/main/core/diagram/_shared/folder-structure-general/v1/folder-structure-general.md):
...
(Read by [`architecture/SKILL.md`](https://github.com/giakhanh22024558/MasterMind/blob/main/models/model_001/diagram/architecture/SKILL.md). See [`architecture/conventions-schema`](https://github.com/giakhanh22024558/MasterMind/blob/main/models/model_001/diagram/architecture/conventions-schema/v1/conventions-schema.md) for the full checklist.)
...
(Add sections as the project adopts new diagram types. Each new diagram type requires a corresponding sub-skill at `models/model_NNN/diagram/<type>/` — see top-level [`SKILL.md`](https://github.com/giakhanh22024558/MasterMind/blob/main/core/diagram/SKILL.md) "Adding a new diagram-type sub-skill" for the 5-step process.)

### DFD conventions

*(Not yet adopted in this template. When adopting:*
- *Add sub-skill at `models/model_NNN/diagram/dfd/` with uniform folder structure*
