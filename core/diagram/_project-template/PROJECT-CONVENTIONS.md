...
The project uses the 4-tier layout from [`_shared/folder-structure-general`](https://github.com/giakhanh22024558/MasterMind/blob/main/core/diagram/_shared/folder-structure-general/folder-structure-general.md):
