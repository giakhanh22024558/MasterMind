...
| Hardware ambiguity | Log as HWG entry (see [hardware-gaps-tracking.md](../../../../models/model_001/diagram/architecture/patterns/hardware-gaps-tracking.md)) |
| Cross-layer read needed | Log as CLR entry (see [cross-layer-reads-tracking.md](../../../../models/model_001/diagram/architecture/patterns/cross-layer-reads-tracking.md)) |
