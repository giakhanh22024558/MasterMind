...
See [`architecture/patterns/`](../../../../models/model_001/diagram/architecture/patterns/) (look for `cross-layer-reads-tracking.md` and `hardware-gaps-tracking.md`) for concrete instantiations.
