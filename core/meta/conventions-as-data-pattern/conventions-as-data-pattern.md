...
1. **`conventions-schema/<schema>.md`** — checklist of what conventions a project MUST define when using this skill
2. **`conventions-defaults/<defaults>.md`** — sensible defaults applied when project doesn't specify
...
- Project: provides `<project>/diagram-conventions.md` based on [`diagram/_project-template/PROJECT-CONVENTIONS.md`](../../diagram/_project-template/PROJECT-CONVENTIONS.md)
- Skill: reads project file per [`diagram/_shared/conventions-discovery/`](../../diagram/_shared/conventions-discovery/conventions-discovery.md)
- Sub-skill: applies project conventions, falls back to `diagram/architecture/conventions-defaults/`
