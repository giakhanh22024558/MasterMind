...
7. Document the new pattern in `<skill>/patterns/<pattern-name>-tracking.md`

## Cross-references in skills

Different skills will reference this pattern from their domain-specific patterns. Examples:

- `diagram/architecture/patterns/cross-layer-reads-tracking.md` (instantiates this pattern for CLR)
- `diagram/architecture/patterns/hardware-gaps-tracking.md` (instantiates for HWG)
