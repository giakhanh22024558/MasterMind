...
| Script | Purpose |
|---|---|
| [`scaffold-new-skill.py`](scaffold-new-skill.py) | Copy `core/template/` to a new skill folder under `models/` and rename placeholders. Quick start for a new skill. |
...
```bash
python core/meta/scripts/scaffold-new-skill.py
```
