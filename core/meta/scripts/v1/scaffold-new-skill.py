"""
Scaffold a new skill by copying the `core/template/v1/` starter
...
WHAT IT DOES:
  1. Copies `core/template/v1/` to `models/<new-skill-name>/`
...
REPO_ROOT = Path(__file__).resolve().parents[4]   # MasterMind/
DEST_ROOT = REPO_ROOT / "models"                  # concrete skills live under models/model_NNN/<diagram|document>/
TEMPLATE_DIR = REPO_ROOT / "core" / "template" / "v1"
...
def main():
    ...
    print("  - Versioning model: core/meta/versioning-pattern/")
