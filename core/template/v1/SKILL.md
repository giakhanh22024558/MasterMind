...
> Every content module in this skill is versioned at the leaf-folder level (`v1/`, `v2/`, …). Default behavior: use the highest `vN`. See [`meta/versioning-pattern/`](../../meta/versioning-pattern/) for the full model.
...
| [Versioning pattern](../../meta/versioning-pattern/) | Every content module versioned at leaf-folder grain |
