...
Walks through the existing [`diagram/`](../../../skills/diagram/) skill, showing how each of the 4 core meta-patterns is instantiated. Use as a reference when creating a new skill.
...
Project side: each adopting project provides `<project-root>/diagram-conventions.md` (template at [`diagram/_project-template/v1/`](../../../skills/diagram/_project-template/v1/PROJECT-CONVENTIONS.md)).
